    ...
    <>
      ...
      <main>  
        ...
        <section className="section-subtitle">
          ...
          {/* Article Section */}
          <section className="section-article relative mx-auto mt-4 flex w-full max-w-[62.5rem] flex-col items-center justify-center gap-5 lg:flex-row">
            <section className="section-article__section flex w-full max-w-[30.625rem] flex-col gap-5">
              {/* 1 Col */}
              <article className="section-article-section__article h-[23.75rem] bg-white shadow-[0px_1px_1px_#D8D8D8BF] p-4">
                
                  <div className="section-article-section-article__title mb-2 flex items-end gap-2">
                    <img
                      src="/Location@2x.png"
                      alt="location_icon"
                      width={30}
                      height={30}
                    />
                    <span className="section-article-section-article-title__text text-[1rem] leading-[1.0625rem] tracking-[0rem] lg:text-[1.375rem]">
                      新東京オフィスの地図はこちら
                    </span>
                  </div>
